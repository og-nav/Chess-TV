...
// ---- Chess TV PATCH BEGIN -------------------------------------------------
// misc.h carries the per-architecture SIMD gate (see the patch in misc.h) and
// must be visible before the USE_* macros below are tested. Upstream reaches
// misc.h only later, through "../types.h".
#include "../misc.h"
// ---- Chess TV PATCH END ---------------------------------------------------
